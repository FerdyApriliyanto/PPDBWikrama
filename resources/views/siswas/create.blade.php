     ...
     <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="radio" name="Jns_kelamin" value="Laki-laki" id="jns_kelamin" selected> Laki-Laki
                <input type="radio" name="Jns_kelamin" value="Perempuan" id="jns_kelamin"> Perempuan
            </div>
        </div>
